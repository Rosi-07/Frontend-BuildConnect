...
import { AddCircleOutlineRounded, EditAttributesOutlined, EditNote, MenuBookOutlined, PersonPinCircleTwoTone } from '@mui/icons-material';
...
const UserProfile = () => {
    ...
    return (
        <div className="relative max-w-4xl p-6 mx-auto bg-white rounded-lg">
            <button
                className="absolute top-6 right-6 flex items-center px-4 py-2 text-[#00455E] border border-[#00455E] bg-white rounded-lg shadow-md hover:bg-[#f0f0f0] transition duration-200 ease-in-out"
            ...
            <div className="max-w-4xl p-6 mx-auto bg-white rounded-lg">
                <div className="flex items-center justify-start mb-6 space-x-4">
                    ...
                    <button
                        ...
                        className="text-lg font-medium text-[#00455E]"
                    >
                        <EditNote />
                    </button>
                    <EditModal
                                    ...
                                    <li key={project.id} className="p-4 border border-gray-100 rounded-md shadow-md cursor-pointer hover:bg-[#00455e0e]">
                                        <div className="relative mb-4">
                                            <button
                                                ...
                                                className="text-[#00455E] hover:text-blue-500"
                                            >
                                            ...
                                            <EditProject
                                                ...
                                                onSave={(updatedProject) => {
                                                    ...
                                                    const updatedProjects = userProfile.projects.map(project =>
