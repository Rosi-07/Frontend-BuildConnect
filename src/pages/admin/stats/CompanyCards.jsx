...
const CompanyCards = () => {
  ...
  return (
    <Card className={clsx("company-cards", cardStyles.card)}>
      <CardContent className={clsx("company-cards-content", cardStyles.content)}>
        <Typography variant="h5" component="h2" className={clsx("company-cards-title", cardStyles.title)}>
          Categorías de Proyectos
        </Typography>
        <Box className={clsx("company-cards-chart-container", cardStyles.chartContainer)}>
          <PieChart
            series={[
              {
                data,
