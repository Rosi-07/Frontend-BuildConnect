  ...
  return (
    ...
    <div className="flex flex-col items-start p-8 mb-10 space-y-6 bg-white shadow-lg rounded-xl md:flex-row md:space-y-0 md:space-x-10">
      ...
      <div className="flex-1">
        <h1 className="mb-4 text-3xl font-extrabold text-[#00455E]">{project.title}</h1>    
        ...
        <p className="mb-6 text-lg leading-relaxed tracking-wide text-gray-700">{project.description}</p>
        <div className="mb-6">
          <div className="flex items-center mb-2">
            <h3 className="text-lg font-medium text-[#00455E] ml-2">Ubicación</h3>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center mb-2">
            <h3 className="text-lg font-medium text-[#00455E] ml-2">Presupuesto Estimado</h3>
          </div>
          <p className="text-lg text-gray-600">${project.budget.toLocaleString()}</p>
        </div>
        <div className="mb-6">
          <h2 className="text-lg font-medium text-[#00455E] ml-2">Fechas Estimadas</h2>
          <ul className="space-y-2 text-lg text-gray-600 list-disc list-inside">
            <li>Fecha de inicio prevista: {new Date(project.startDate).toLocaleDateString()}</li>
    ...
    <div className="flex items-start mb-6">
      ...
      <div>
        <h3 className="mb-1 text-lg font-medium text-[#00455E]">Propietario</h3>
        <p className="text-lg text-gray-600">
          {project.Owner.name || ""} {project.Owner.lastname || ""} {project.Owner.lastname2 || ""}
        </p>
        <p>Correo electrónico: {project.Owner.User.email}</p>
        <h3 className="mb-1 text-lg font-medium text-[#00455E]">Contactos</h3>
        <p className="text-lg text-gray-600">
