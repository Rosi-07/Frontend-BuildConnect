  ...
  return (
    <div className="min-h-screen p-10 bg-white">
      ...
      <div className="flex-1">
        <h1 className="mb-4 text-4xl font-extrabold text-[#00455E]">{project.title}</h1>
        <div className="flex items-center mb-6 space-x-4 text-lg text-[#00455E]">
          <span className="px-3 py-1 bg-[#e2e2e2] rounded-full">{project.projectType}</span>
          <span className="px-3 py-1 bg-[#e2e2e2] rounded-full">{project.Category.name}</span>
        </div>
        <p className="text-lg leading-relaxed tracking-wide text-gray-700">{project.description}</p>
      </div>
    </div>

    {/* detalles */}
      <div className="p-6 mb-12 bg-white shadow-lg rounded-xl">
        <h2 className="mb-4 text-2xl font-semibold text-[#00455E]">Detalles del Proyecto</h2>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="flex items-start">
            <div className="mr-4">
              <svg className="w-8 h-8 text-[#00455E]" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 2C5.58 2 2 5.58 2 10s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm1 14v-4H9v4H6v-6H4l6-6 6 6h-2v6h-3z" />
              </svg>
            </div>
            <div>
              <h3 className="mb-1 text-lg font-medium text-[#00455E]">Ubicación</h3>
          ...
          <div className="flex items-start">
            ...
            <div>
              <h3 className="mb-1 text-lg font-medium text-[#00455E]">Presupuesto Estimado</h3>
              <p className="text-lg text-gray-600">${project.budget.toLocaleString()}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 mb-12 bg-white shadow-lg rounded-xl">
        <h2 className="mb-4 text-2xl font-semibold text-[#00455E]">Información del Cliente</h2>
        <div className="flex items-start">
          <div className="mr-4">
            <svg className="w-8 h-8 text-[#00455E]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            <h3 className="mb-1 text-lg font-medium text-[#00455E]">Nombre del Cliente</h3>
            <p className="text-lg text-gray-600">{project.User.name} {project.User.lastName}</p>
          </div>
        </div>
      </div>

      <div className="p-6 bg-white shadow-lg rounded-xl">
        <h2 className="mb-4 text-2xl font-semibold text-[#00455E]">Fechas Estimadas</h2>
...
// <div className="flex flex-col items-start p-8 mb-10 space-y-6 bg-[#00455e0e] shadow-lg md:flex-row rounded-xl md:space-y-0 md:space-x-10">
//   <img
